...
namespace BitsOnCoffee.Datatables.Extensions
{
	public static class DatatablesExtensions
	{
		...
		public static Datatable CreateDatatable(this Namespaces.Datatables datatable, string selector, string actionName, string controllerName, string areaName, bool paginate = true, object routeParams = null)
		{
			...
			return new Datatable(datatable, selector, url, paginate);
		}
	}
}
